...
<div class="nav-item dropdown mx-3 d-lg-none d-xl-none custom-dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-end m-0 shadow p-2 bg-body rounded" style="width: 100%;">
        <!-- Tab panes -->
...
$(document).ready(function () {
    var name = "<?php echo $name; ?>"; // Add quotes around the PHP value
    var email = "<?php echo $email; ?>"; // Add quotes around the PHP value
    function load_unseen_notification(view = '') {
        $.ajax({
            url: "fetch.php",
            method: "POST",
            data: { view: view, name: name, email: email },
            dataType: "json",
