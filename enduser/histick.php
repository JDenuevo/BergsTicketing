...
<title>Ticket History | BITS</title>
...
<body>
              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="navbar-nav text-uppercase">
                      ...
                      <li class="nav-item">
                        <a class="nav-link px-lg-3 fw-bold active" href="histick.php"><i class="fa-solid fa-file-lines"></i> Ticket History</a>
                      </li>
                      <li class="nav-item">
    ...
    <div class="container-fluid pt-4 px-5">
      ...
      <div class="vh-100 mx-0">
        <?php
        $sql = "SELECT * FROM bits_tickets WHERE email = '$email1' ORDER BY date_created Desc";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="card-footer bg-transparent border-primary">
         ...
         <?php // Generate stars based on the ticket rate
            for ($i = 1; $i <= 5; $i++) {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.performance) {
      if (performance.navigation.type == 1) {
        ...
        window.location.href = "histick.php";
      }
    }</script>
</html>
